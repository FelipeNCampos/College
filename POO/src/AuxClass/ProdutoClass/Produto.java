...
public class Produto{
    ...
    public void vender(int quantidade){
        if (this.quantidade >= quantidade){
            ...
            System.out.println("____________________Venda efetuada ____________________\nValor da Venda R$" + nota);
        }else{
